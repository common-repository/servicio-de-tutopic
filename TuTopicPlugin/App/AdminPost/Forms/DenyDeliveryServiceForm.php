...
class DenyDeliveryServiceForm {
    function handle($data) {
      ...
      if ( !empty( $_POST['comment'] ) && (strlen($_POST['comment']) > 256 || strlen($_POST['comment']) < 4) ) {
        PopaloUtils::redirectWithError($sender_url, 'El comentario que envie al rechazar una entrega debe estar entre 4 y 256 caracteres.', 400);
      }
